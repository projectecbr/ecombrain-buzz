...
// Reference-stable snapshots for useSyncExternalStore. The first subscription
// invalidates them after React's pre-subscribe reads, then notifications keep
// them current while mounted.
